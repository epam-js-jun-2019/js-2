импорты common.js, работает на node.js

чтобы посмотреть, как все работает, можно зайти в test.js (там есть примеры вызовов и тд)

в папке api - вспомогательные вещи, основные классы в общей папке
